module Map.Style exposing (light)
...
greenSpace =
    E.rgba 120 206 101 1


sandSpace =
    E.rgba 239 232 210 1
...
light additionalSources additionalLayers =
    Style
        ...
        , sources = Source.vectorFromUrl "composite" "mapbox://mapbox.mapbox-terrain-v2,mapbox.mapbox-streets-v7" :: additionalSources
        , misc =
        ...
        , layers =
            ...
            , Layer.fill "water" "composite" [ Layer.sourceLayer "water", Layer.fillColor waterSpace ]
